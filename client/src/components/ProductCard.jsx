...
const ProductCard = ({ product }) => {
  ...
  if (!product || !product.image || !product.image.length) return null;

  const ratingValue = Math.round(Number(product.rating)) || 4;
          ...
          {Array(5)
            ...
            .map((_, i) => (
              <img
                ...
                src={i < ratingValue ? assets.star_icon : assets.star_dull_icon}
                alt="star"
              />
            ))}
          <p>({ratingValue})</p>
