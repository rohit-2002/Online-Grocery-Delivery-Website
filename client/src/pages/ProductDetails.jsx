    ...
    <div className="mt-12 px-4 md:px-10">
      ...
      <div className="flex flex-col md:flex-row gap-16 mt-4">
        ...
        <div className="flex gap-3">
          ...
          {/* Main Image */}
          <div className="border border-gray-300 w-[300px] md:w-[350px] h-auto rounded overflow-hidden">
            <img
              src={thumbnail}
        ...
        <div className="text-sm w-full md:w-1/2">
          ...
          <div className="flex items-center gap-1 mt-1">
            ...
            <p className="ml-2 text-gray-600 text-sm">(4)</p>
          </div>
      ...
      <div className="flex flex-col items-center mt-20">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 md:gap-65 lg:grid-cols-5 mt-6 w-full">
          {relatedProducts
        ...
        <button
          ...
          className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hovor:bg-primary/10 transition"
        >
          See more
        </button>
      </div>
